...
object JobIdManager {
    const val JOB_TYPE_CHANNEL_PROGRAMS = 1
    const val JOB_TYPE_CHANNEL_METADATA = 2
    const val JOB_TYPE_CHANNEL_DELETION = 3
    const val JOB_TYPE_CHANNEL_LOGGER = 4

    const val JOB_TYPE_USER_PREFS = 11
    const val JOB_TYPE_USER_BEHAVIOR = 21
    ...
    fun getJobId(
       ...
       (jobType shl JOB_TYPE_SHIFTS) + objectId
    } else {
